  ...
  return `	
    <div class="quiz-question">
      ...
      <div class="quiz-bottom">
        ...
        <button type="button" class="quiz-question__btn btn btn-reset btn--quiz" data-next-btn>${nextBtnText}</button>
      </div>	
    </div>
	`
}
  ...
  nextQuestion() {
    ...
    if (this.valid()) {
      if (this.counter + 1 < this.dataLength) {
        ...
        document.querySelector('.quiz-asd').style.display = 'block'
      }
    } else {
